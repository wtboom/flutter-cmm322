      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              top: MediaQuery.of(context).size.height * 0.10 + 130,
              left: (MediaQuery.of(context).size.width - 160) / 2,
              child: Stack(
                children: [
                  Container(
            ...
            Positioned(
              top: MediaQuery.of(context).size.height * 0.40 - 15,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            '+2.4%',
                            style: TextStyle(
                                fontSize: 14, color: Color(0xFF02C275)),
                          ),
                        ),
                      ],
                    ),
            ...
            Positioned(
              top: MediaQuery.of(context).size.height * 0.65 - 20,
              left: MediaQuery.of(context).size.width * 0.05,
              child: Container(
                width: MediaQuery.of(context).size.width * 0.9,
